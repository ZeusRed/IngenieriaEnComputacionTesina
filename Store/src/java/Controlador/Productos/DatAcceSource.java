...
@WebServlet(name = "DatAcceSource", urlPatterns = {"/DatAcceSource"})
public class DatAcceSource extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("lst", content);*/
            ...
            request.getRequestDispatcher("Vistas/Productos/Accesorios.jsp").forward(request, response);
        }
    }
