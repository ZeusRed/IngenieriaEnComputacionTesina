 ...
 * @author Reynaldo
 */
@WebServlet(name = "DeleteCattipoUsuario", urlPatterns = {"/DeleteCattipoUsuario"})
public class DeleteCattipoUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             int valorSubmit = Integer.parseInt(request.getParameter("id"));
              ...
              int estatus=manager.borrarCatTipoUsuario(valorSubmit);
              if (estatus == 1) {
