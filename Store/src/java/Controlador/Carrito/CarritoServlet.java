...
public class CarritoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Usuario usuario = manager.GetUsuario(idUser);
            CarritoManager carrito= new CarritoManager();
            List<ProductoCarrito> prodsCarrito= new ArrayList<>();
            prodsCarrito=carrito.GetCarrito(idUser);
              request.setAttribute("carrito", prodsCarrito);
