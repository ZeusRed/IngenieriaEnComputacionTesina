...
public class ConsultarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Producto prod = manager.GetProd(valorSubmit);
            request.setAttribute("detalle", prod);

            request.getRequestDispatcher("Vistas/Productos/detalleProducto.jsp").forward(request, response);
        }
    }
