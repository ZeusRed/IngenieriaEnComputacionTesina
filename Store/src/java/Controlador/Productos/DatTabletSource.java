...
@WebServlet(name = "DatTabletSource", urlPatterns = {"/DatTabletSource"})
public class DatTabletSource extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("lst", content);*/
          ...
          /*  for (Producto prod : prods) {
            ...
            request.getRequestDispatcher("Vistas/Productos/Tablets.jsp").forward(request, response);
        }
    }
