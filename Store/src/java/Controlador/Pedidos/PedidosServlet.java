...
public class PedidosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            SessionLogic sl1 = new SessionLogic();
            sl1 = (SessionLogic) request.getSession().getAttribute("sessionUsuario");
            List<DetalleVenta> listaProds = new ArrayList<>();
            ...
            if (val != null) {
                ...
                listaProds = manager.ListProductosVenta(id);
                request.setAttribute("pedidos", listaProds);

            } else {
                request.setAttribute("pedidos", listaProds);
            }
            request.getRequestDispatcher("Vistas/Pedidos/index.jsp").forward(request, response);
        }
    }
