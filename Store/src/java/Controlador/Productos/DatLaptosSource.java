...
@WebServlet(name = "DatLaptosSource", urlPatterns = {"/DatLaptosSource"})
public class DatLaptosSource extends HttpServlet {
...
//                        prodsInner.add(prod);
            ...
            request.getRequestDispatcher("Vistas/Productos/Laptops.jsp").forward(request, response);
        }
    }
