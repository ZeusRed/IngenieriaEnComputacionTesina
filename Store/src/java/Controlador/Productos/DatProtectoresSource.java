...
@WebServlet(name = "DatProtectoresSource", urlPatterns = {"/DatProtectoresSource"})
public class DatProtectoresSource extends HttpServlet {
        ...
        request.setAttribute("lst", content);*/
         ...
         /*   for (Producto prod : prods) {
            ...
            request.setAttribute("map", map);
                ...
                request.getRequestDispatcher("Vistas/Productos/Protectores.jsp").forward(request, response);
        }
    }
